 ...
 * 			- 기본 타입을 객체 처럼 사용 가능하게 suppert해 주는 클래스
 * 5. 주요 API
 * 	1. 저장/활용(반환)/삭제
...
public class ListTest {
	 ...
	 * public Object get(int index){ 해당 index에 저장되어 있는 데이터 반환}
	 */
	...
	public static ArrayList<CustomerDTO> getCustomers(){
		...
		ArrayList<CustomerDTO> all = new ArrayList<CustomerDTO>();//10개 메모리 생성
	...
	public static void main(String[] args) {
		 ...
		 */
		System.out.println(all.get(1).getId()); //u2
//		m4();
//		m3();
//		m();
	}
